...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "any.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
Any::Any()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_any_2eproto::InitDefaultsAny();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* Any::descriptor() {
  ::protobuf_any_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_any_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata Any::GetMetadata() const {
  protobuf_any_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_any_2eproto::file_level_metadata[kIndexInFileMessages];
}
